...
function generateRandomData(): AtelierData {
  const destinations = ['Atelier VMI 2', 'Atelier VML 1', 'Atelier VML 2', 'Stock Principal'];
  const sources = ['Atelier PG', 'Atelier VMI 2', 'Stock Externe', 'Production Interne'];
  const dechireuseTypes = ['VMI1-A', 'VMI1-B', 'VMI1-C'];
...
export default function AtelierVMI1Page() {
    ...
    <div className="p-6">
      <div className="mb-6 flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600">
            Gestion et monitoring de l'Atelier VMI 1 - Usine A
          </p>
        </div>
        <div className="flex gap-2">
          ...
          <Button 
            onClick={() => router.push('/dashboard/atelier-vmi-1/create')}
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <div className="bg-white p-6 rounded-lg shadow-sm border">
          ...
          <p className="text-sm text-gray-500 mt-1">Depuis 08:00</p>
        </div>
        <div className="bg-white p-6 rounded-lg shadow-sm border">
